...
import { Recycle, AlertTriangle, Globe, TrendingUp } from "lucide-react"
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-muted-foreground">
                <li>• 50+ million metric tons of e-waste generated annually</li>
                <li>• E-waste is the fastest-growing waste stream globally</li>
                <li>• Only 17.4% is properly documented as recycled</li>
                <li>• Expected to reach 74 million metric tons by 2030</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-muted-foreground">
                <li>• $57 billion worth of materials in annual e-waste</li>
                <li>• More gold in e-waste than in gold mines</li>
                <li>• Recycling more cost-effective than mining</li>
